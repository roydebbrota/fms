                                ...
                                <div class="card-inner card-inner-lg">
                                    ...
                                    <div class="nk-block-head nk-block-head-lg">
                                        ...
                                        <div class="nk-block-between">
                                            <div class="nk-block-head-content">
                                                <h4 class="nk-block-title">Create Visit Type</h4>
                                            </div>
                                    ...
                                    <div class="nk-block">
                                        <div class="nk-data data-list">
                                                <form action="{{ route('visit-type.store') }}" method="POST">
                                                     @csrf
                                                    ...
                                                    <div class="col-lg-5">
                                                        <div class="form-group mt-4">
                                                            <button type="submit" class="btn btn-lg btn-primary">Add Visit Type</button>
                                                        </div>
                                                    </div>
                                                </form>
                                        </div>
                                      ...
                                      @forelse($visit_types  as $type)
                                          <tr>
                                              ...
                                              <td>
                                                  ...
                                                  <button class="btn btn-sm btn-danger" onclick="if(confirm('do you wont to delete')){document.getElementById('visit_delete_form').submit();
                                                          ...
                                                          <div class="modal-content">
                                                            <div class="modal-header">
                                                              ...
                                                              <div class="modal-body">
                                                                  <form action="{{ route('visit-type.update',$type->id) }}" method="POST">
                                                                    @csrf
                                            ...
                                            <form action="{{route('visit-type.destroy',$type->id)}}" method="POST" id="visit_delete_form">
                                                @csrf
                                                @method('DELETE')
                                          ...
                                          @empty
                                               <h2 class="text-danger text-center">There is no Visit type</h2>
                                      @endforelse
                                        </tbody>
                                      </table>
                                      </div>
